...
public class ExifSubIFDDescriptor extends TagDescriptor<ExifSubIFDDirectory>
{
    ...
    public String getDescription(int tagType)
    {
        switch (tagType) {
            ...
            case ExifSubIFDDirectory.TAG_FOCAL_PLANE_RESOLUTION_UNIT:
                return getFocalPlaneResolutionUnitDescription();
            case ExifSubIFDDirectory.TAG_FOCAL_PLANE_X_RESOLUTION:
                return getFocalPlaneXResolutionDescription();
            case ExifSubIFDDirectory.TAG_FOCAL_PLANE_Y_RESOLUTION:
    ...
    {
        Rational rational = _directory.getRational(ExifSubIFDDirectory.TAG_FOCAL_PLANE_X_RESOLUTION);
        if (rational == null)
            return null;
    ...
    {
        Rational rational = _directory.getRational(ExifSubIFDDirectory.TAG_FOCAL_PLANE_Y_RESOLUTION);
        if (rational == null)
            return null;
        final String unit = getFocalPlaneResolutionUnitDescription();
        return rational.getReciprocal().toSimpleString(_allowDecimalRepresentationOfRationals)
    ...
    public String getFocalPlaneResolutionUnitDescription()
    {
        ...
        return getIndexedDescription(ExifSubIFDDirectory.TAG_FOCAL_PLANE_RESOLUTION_UNIT,
            1,
            "(No unit)",
            "Inches",
            "cm"
