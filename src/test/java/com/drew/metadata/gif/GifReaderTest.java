...
public class GifReaderTest
{
    ...
    {
        GifHeaderDirectory directory = processBytes(filePath("mspaint-10x10.gif"));
    ...
    {
        GifHeaderDirectory directory = processBytes(filePath("photoshop-8x12-32colors-alpha.gif"));
