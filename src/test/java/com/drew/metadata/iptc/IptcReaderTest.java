...
/**
 * Unit tests for {@link com.drew.metadata.iptc.IptcReader}.
 *
...
public class IptcReaderTest
{
    ...
    {
        IptcDirectory directory = processBytes(filePath("iptc1.jpg.appd"));
    ...
    {
        IptcDirectory directory = processBytes(filePath("iptc2-photoshop6.jpg.appd"));
