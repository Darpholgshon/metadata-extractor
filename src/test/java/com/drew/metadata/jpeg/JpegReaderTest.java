...
public class JpegReaderTest
{
    ...
    {
        _directory = processBytes(filePath("simple.jpg.sof0"));
    }
...
/*
    ...
    public void testJpegWithAudio() throws Exception
    {
        ...
        File jpegFile = new File("Tests/com/com.drew/metadata/jpeg/audioPresent.jpg");
...
//        System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SOI));
        ...
        File audioFile = new File("Tests/com/com.drew/metadata/jpeg/audio.wav");
