...
public class ExifReaderTest
{
    ...
    {
        ExifSubIFDDirectory directory = ExifReaderTest.processBytes(filePath("withExif.jpg.app1"), ExifSubIFDDirectory.class);
...
//      assertEquals("F9", directory.getDescription(ExifSubIFDDirectory.TAG_APERTURE));
    ...
    public void testCrashRegressionTest() throws Exception
    {
        ...
        ExifSubIFDDirectory directory = ExifReaderTest.processBytes(filePath("crash01.jpg.app1"), ExifSubIFDDirectory.class);
    ...
    {
        ExifIFD0Directory directory = ExifReaderTest.processBytes(filePath("manuallyAddedThumbnail.jpg.app1"), ExifIFD0Directory.class);
    ...
    {
        ExifThumbnailDirectory directory = ExifReaderTest.processBytes(filePath("manuallyAddedThumbnail.jpg.app1"), ExifThumbnailDirectory.class);
    ...
    public void testStackOverflowOnRevisitationOfSameDirectory() throws Exception
    {
        ...
        Metadata metadata = processBytes(filePath("recursiveDirectories.jpg.app1"));
    ...
    public void testDifferenceImageAndThumbnailOrientations() throws Exception
    {
        ...
        Metadata metadata = processBytes(filePath("repeatedOrientationTagWithDifferentValues.jpg.app1"));
