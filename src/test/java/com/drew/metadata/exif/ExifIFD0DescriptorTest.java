...
/**
 * Unit tests for {@link com.drew.metadata.exif.ExifIFD0Descriptor}.
 *
...
public class ExifIFD0DescriptorTest
{
    ...
    {
        ExifIFD0Directory directory = ExifReaderTest.processBytes(filePath("windowsXpFields.jpg.app1"), ExifIFD0Directory.class);
