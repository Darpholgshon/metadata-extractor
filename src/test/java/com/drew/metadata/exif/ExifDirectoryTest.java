...
/**
 * Unit tests for {@link com.drew.metadata.exif.ExifSubIFDDirectory}, {@link com.drew.metadata.exif.ExifIFD0Directory}, {@link com.drew.metadata.exif.ExifThumbnailDirectory}.
 *
...
public class ExifDirectoryTest
{
    ...
    {
        ExifThumbnailDirectory directory = ExifReaderTest.processBytes(filePath("withExif.jpg.app1"), ExifThumbnailDirectory.class);
...
//    }
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes(filePath("withUncompressedRGBThumbnail.jpg.app1"));
