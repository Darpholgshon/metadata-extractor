...
public class PngChunkTypeTest
{
    ...
    public void testConstructorTooLong() throws Exception
    {
        try {
            ...
            assertEquals("PNG chunk type identifier must be four bytes in length, was 7", ex.getMessage());
        }
    }
    ...
    public void testConstructorTooShort() throws Exception
    {
        try {
            ...
            assertEquals("PNG chunk type identifier must be four bytes in length, was 3", ex.getMessage());
        }
    }
    ...
    public void testConstructorInvalidBytes() throws Exception
    {
        ...
        for (String invalidString : invalidStrings) {
            System.out.println("Source String: [" + invalidString + "]");
