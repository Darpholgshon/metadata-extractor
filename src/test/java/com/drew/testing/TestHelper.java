...
public class TestHelper {
  ...
  public static String filePath(String resourcePath) {
    return ClassLoader.getSystemResource(resourcePath).getPath();
  }

  public static File file(String resourcePath) {
    return new File(filePath(resourcePath));
  }

  public static FileInputStream fileAsStream(String resourcePath)
          throws FileNotFoundException {
    return new FileInputStream(file(resourcePath));
  }
}
